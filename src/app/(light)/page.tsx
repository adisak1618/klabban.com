...
export default function Home() {
  ...
  return (
    <div className="">
      <div className="relative page-hero-shape h-[98vh] w-full overflow-hidden gray-gradient relative">
        <motion.div
          style={{
            y: backgroundTextY,
          }}
        ...
        <div className="container relative max-w-6xl w-full h-full  mx-auto">
          ...
          <motion.div
            ...
            //   y: 0,
            // }}
            className="absolute flex flex-col justify-center items-center bottom-0 mb-28 lg:mb-40 w-full lg:max-w-lg px-10 left-0"
          >

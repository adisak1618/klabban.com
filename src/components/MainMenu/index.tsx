    ...
    >
      {({ menus }) => (
        <div
          ...
          className={clsx(
            "h-[60px] flex items-center text-navigation-text bg-opacity-40",
            !light && "border-b border-border",
            light && "light-navigation absolute w-full top-0 left-0 z-20"
          )}
        >
          <div className="container-content w-full flex flex-wrap items-center">
            ...
            <div className="hidden flex-1 md:flex flex-wrap h-[60px]">
              {menus.map((menu) => (
                <MenuWrapper
                  key={menu.id}
                  className="group leading-[60px] font-medium hover:font-semibold content-stretch capitalize hover:border-b-2 border-primary"
                >
                  <>
                    {menu.label}
                    <SubMenu />
            ...
            <div className="flex justify-normal social">
              <MenuWrapper className="w-[60px] leading-[60px] zoom-in py-4">
                <svg
                  height="100%"
                  version="1.1"
                  viewBox="0 0 512 512"

...
export function Social() {
  return (
    <div className="flex justify-normal social">
      <a target="_blank" href="https://web.facebook.com/adisak.chaiyakul.14">
        <MenuWrapper className="w-[70px] leading-[70px] zoom-in py-5">
          <svg
            height="100%"
            version="1.1"
            viewBox="0 0 512 512"
      ...
      <a href="https://www.youtube.com/channel/UCPIxgIO_pZqc-mvJ0YcTEaw">
        <MenuWrapper className="w-[70px] leading-[70px] zoom-in py-5">
          <svg
            height="100%"
            version="1.1"
      ...
      <a href="https://www.instagram.com/oat1618/">
        <MenuWrapper className="w-[70px] leading-[70px] zoom-in py-5">
          <svg
            height="100%"
            width="100%"
